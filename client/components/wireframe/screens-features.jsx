...
import { Spec, Frame, Shell, TopBits, B, Ph, Panel, Bars, Stat } from "./primitives";

/* ============ POLICY ENGINE + VIOLATIONS ============ */
export function SecPolicy() {
  return (
    <div>
...
export function SecTransactions() {
  return (
    <div>
      <div className="sec-head">
