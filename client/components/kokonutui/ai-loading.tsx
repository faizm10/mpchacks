...
const TASK_SEQUENCES = [
  {
    status: "Querying fleet data",
    lines: [
      "Loading transaction records...",
      "Scanning 4,235 fleet expenses...",
      "Filtering by date and merchant...",
      "Matching policy rules...",
      "Preparing summary...",
    ],
  },
  {
    status: "Analyzing spend patterns",
    lines: [
      "Grouping by category...",
      "Detecting split charges...",
      "Checking MCC codes...",
      "Flagging suspicious merchants...",
      "Calculating totals...",
      "Building chart data...",
    ],
  },
  {
    ...
    lines: [
      ...
      "Mapping transactions to routes...",
